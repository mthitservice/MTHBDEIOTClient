...
# Arbeitsverzeichnis setzen - Scripts sollten im Repository Root ausgeführt werden
...
if (Test-Path $versionJsonPath) {
    try {
        ...
        # Platform-spezifische URLs aktualisieren
    ...
    Write-Error "version.json nicht gefunden: $versionJsonPath"
    exit 1
}

# GitHub Upload über das Update-System Script
try {
