...
Write-Host "  • Azure DevOps: https://dev.azure.com/your-org/MthBdeIotClient/_build"
Write-Host "  • GitHub Releases: https://github.com/mthitservice/MTHBDEIOTClient/releases"
Write-Host "  • Latest Release: https://github.com/mthitservice/MTHBDEIOTClient/releases/latest"
Write-Host ""
